<script lang='ts'>
    ...
    const thisWeekSwims = getThisWeekActivities(swims);
    const distanceSwum = calculateTotalDistance(thisWeekSwims);
    const movingTime = calculateTotalMovingTime(thisWeekSwims);
    ...
    <div class="fifi-card-overview-body">
        ...
        <div class="fifi-card-col">
            <p class='fifi-body-item'>
                <Icon name='Swim' size='22' color='#0090E3' />
                <span>Distance swum: {distanceSwum.toPrecision(3)} kms</span>
            </p>
            <p class='fifi-body-item'>
